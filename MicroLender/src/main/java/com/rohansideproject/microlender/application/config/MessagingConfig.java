package com.rohansideproject.microlender.application.config;
...
import com.rohansideproject.microlender.domain.event.UserRegisteredEventHandler;
...
public class MessagingConfig {
	...
	private static final String QUEUENAME = "user.registered.lending";
